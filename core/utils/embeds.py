...
References
----------
https://github.com/Sachaa-Thanasius/Beira/blob/main/utils/embeds.py
"""
...
__all__ = ("DTEmbed", "PaginatedEmbed", "StatsEmbed", "EMOJI_URL")
    ...
    **kwargs
    ...
    def __init__(
            ...
            *,
            ...
            stat_emojis: Sequence[discord.Emoji | str] | None = (),
    ...
    def add_stat_fields(
            ...
            *,
            ...
            stat_emojis: Sequence[discord.Emoji | str],
    ...
    def add_leaderboard_fields(
            ...
            *,
            ...
            ldbd_emojis: Sequence[discord.Emoji | str],
            name_format: str = "| {}",
            value_format: str = "{}",
            inline: bool = False,
            ranked: bool = True
    ...
    @staticmethod
    def lengthen_emoji_list(baseline_list: Sequence[Any], emojis: Sequence[discord.Emoji | str]) -> Sequence[discord.Emoji | str]:
