"""
help.py: A custom help command for the bot set through a cog.

References
----------
https://github.com/Sachaa-Thanasius/Beira/blob/main/exts/help.py
"""
...
class CustomHelpCommand(commands.HelpCommand):
    """The custom help command for the bot."""
...
class HelpCog(commands.Cog, name="Help"):
    """A cog that allows more dynamic usage of :class:`CustomHelpCommand`."""
    ...
    async def help(self, interaction: core.Interaction, command: str | None = None) -> None:
